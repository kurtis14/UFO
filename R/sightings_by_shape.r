...
#' a table or barplot, from \url{http://www.nuforc.org/webreports.html}.
...
#' @return Either a barplot (generated by ggplot2)
#' or a table of frequencies
#' @keywords misc
#' @export
#' @examples
...
#' @seealso \code{\link{latest.sightings}}
